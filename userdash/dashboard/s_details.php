...
if(isset($_POST['post'])){
  ...
  $insert = "INSERT INTO course_data(course_name,topic,content) VALUES('$course','$topic','$content')";
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled="" placeholder="Company" value="Tech Gladiators Inc.">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Username</label>
                        <input type="text" class="form-control" placeholder="Username" value="<?php echo $row['name'];?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Phone</label>
                        <input type="text" class="form-control" placeholder="Country" value="<?php echo $row['mobile'];?>">
                      </div>
                    </div>
