...
$sql="SELECT * FROM userdata WHERE role=2";
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <tr style="background-color:white; font-size: 14px;">
                ...
                echo "<a class='btn btn-sm btn-primary' href='s_details.php?id=".$row['id']."'>Edit</a>&nbsp;";
        ...
        <div class="container-fluid">
          <div class="row">
            <nav class="footer-nav">
              <ul>
                <li><a href="https://www.creative-tim.com" target="_blank">Tech Gladiators</a></li>
