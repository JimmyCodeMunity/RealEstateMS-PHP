...
if(isset($_POST['post'])){
  ...
  $insert = "INSERT INTO notice(message) VALUES('$notice')";
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Add Notice</a>
          </div>
                ...
                <form action="" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>sender</label>
                        <input type="text" class="form-control" name="name" value="<?php echo $_SESSION['admin_name']?>">
                      </div>
                    </div>
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>About</label>
                        <textarea class="form-control" placeholder="enter notice"rows ="3" name="message"></textarea>
                      </div>
                    </div>
